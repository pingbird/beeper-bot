...
Map<Type, Metadata> get moduleMetadata => {
      ...
      HotReloadModule: Metadata(name: 'hot_reload', lazyLoad: true, factory: (dynamic data) => HotReloadModule()),
      ...
      AdminModule: Metadata(name: 'admin', lazyLoad: true, factory: (dynamic data) => AdminModule(uri: data['uri'] as String, development: data['development'] as bool, adminPort: data['adminPort'] as int, webdevPort: data['webdevPort'] as int)),
