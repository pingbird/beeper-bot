...
class HttpException implements Exception {
  ...
  factory HttpException.fromRawResponse(BaseResponse response) {
    ...
    //
    // Chopper is already generally upstreamed, but if you need to convert a
    // StreamedResponse to a Response, use Request.fromStream.
  ...
  static void ensureSuccessRaw(Response response) {
    if (response.statusCode ~/ 100 != 2) {
      throw HttpException.fromRawResponse(response);
    }
  }
